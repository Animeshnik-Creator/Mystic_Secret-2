...
public class BlockMistichieskiiTsvietochiek extends ElementsMysticSecretMod.ModElement {
	@GameRegistry.ObjectHolder("mystic_secret:mistichieskii_tsvietochiek")
	public static final Block block = null;
	public BlockMistichieskiiTsvietochiek(ElementsMysticSecretMod instance) {
		super(instance, 1);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("mystic_secret:mistichieskii_tsvietochiek", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(1F);
			setUnlocalizedName("mistichieskii_tsvietochiek");
			setRegistryName("mistichieskii_tsvietochiek");
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(BlockMistichieskiiTsvietochiek.block, (int) (1)));
		}

		@Override
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(BlockMistichieskiiTsvietochiek.block, (int) (1));
		}
